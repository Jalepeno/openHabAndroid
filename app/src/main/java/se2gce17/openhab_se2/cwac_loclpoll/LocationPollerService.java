package se2gce17.openhab_se2.cwac_loclpoll;
/**
   ...
   */
	...
	*/
	private class PollerThread extends WakefulThread {
     	...
     	*          or timeout occurs
     	*/
		PollerThread(PowerManager.WakeLock lock, LocationManager locationManager, LocationPollerParameter locationPollerParameter) {
